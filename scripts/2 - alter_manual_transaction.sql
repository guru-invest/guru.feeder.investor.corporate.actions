...
ALTER TABLE wallet.manual_transactions ADD post_event_quantity numeric NULL;
...
update wallet.manual_transactions set post_event_symbol = symbol, post_event_quantity = quantity, post_event_price = price;
